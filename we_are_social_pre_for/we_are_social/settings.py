...
SECRET_KEY = 's&v&z74w9b87ybd=o4c_zzzj0e^p*n+@kf2rc@1q5va4z++7_^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1','624e7d93.ngrok.io', 'localhost']
...
PAYPAL_NOTIFY_URL = 'http://624e7d93.ngrok.io/a-very-hard-to-guess-url/'
